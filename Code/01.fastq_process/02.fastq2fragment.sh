...
AMULET=~/pcisatlas/tools/AMULET-1.1
...
echo -e "Processing......filtering by fastp, date: `date`"
...
##align and filter
echo -e "Processing......chromap mapping and filtering, date: `date`"
...
echo -e "Processing......generating fragment file, date: `date`"
...
#fragments length < 1000, remove MT reads
echo -e "Processing......filer fragments (step 1), date: `date`"
...
echo -e "Processing......Computing TSS for the each barcode, date: `date`"
...
#TSS enrichment sore > 2
#nucleosome signal < 4
echo -e "Processing......filter fragments (step 2), date: `date`"
...
## QC summary and plot
echo -e "Processing......QC plot 1, date: `date`"
...
## Doublets detection
echo -e "Processing......doublets detection with AMULET, date: `date`"
...
## plot final
echo -e "Processing......QC plot (filnal), date: `date`"
